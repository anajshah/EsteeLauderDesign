...
struct prod2: View {
    var body: some View {
        ZStack{
            ...
            Link("Purchase", destination: URL(string: "https://www.esteelauder.com/product/688/112202/product-catalog/skincare/moisturizer/nutritious/melting-soft-crememask-moisturizer?size=1.7_oz.")!)
                .font(.system(size: 20, design: .rounded))
...
struct prod2_Previews: PreviewProvider {
